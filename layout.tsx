                        ...
                        >
                            <div className="h-10 w-10 rounded-full flex items-center justify-center bg-gray-200 text-slate-700 font-semibold">
                                {user?.profilePic ? (
                                    ...
                                    // Render initials in the same case as supplied
                                    <span>
                                        {user?.name
                                            ?.split(" ")
                                            .map((n) => n[0])
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="h-8 w-8 rounded-full flex items-center justify-center bg-gray-200 text-slate-700 font-semibold lg:hidden">
                            {user?.profilePic ? (
                                <div
